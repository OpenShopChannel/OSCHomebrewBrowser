...
#---------------------------------------------------------------------------------
LIBS	:=  -lfat -lmxml -lwiiuse -lbte -lvorbisidec -lasnd -logg -lmad -lgrrlib -ljpeg -lpngu -lpng -lcurl -lm -logc -lmbedtls -lmbedx509 -lwiisocket -lmbedcrypto -lfreetype -lbz2 -lz
